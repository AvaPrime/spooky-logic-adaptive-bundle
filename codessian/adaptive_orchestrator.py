...
class CodessianAdaptiveOrchestrator:
    ...
    handling external capabilities, and running the main adaptation loop.
    """
    ...
    async def initialize(self):
        ...
        This method loads policies, starts the absorption loop if enabled,
        and begins the main adaptation loop.
        """
    ...
    async def _main_adaptation_loop(self):
        ...
        This loop periodically evaluates policies and executes adaptations based
        on the triggered rules.
        """
    ...
    async def swap_agent(self, agent_type: str, replacement: str):
        ...
        Args:
            agent_type (str): The type of agent to replace.
            replacement (str): The new agent implementation.

        Returns:
            dict: A dictionary indicating success and the old/new agent info.
        """
    ...
    async def enable_debate_mode(self, task_types):
        ...
        Args:
            task_types (list[str]): A list of task types to enable debate mode for.

        Returns:
            dict: A dictionary indicating success and the current active workflows.
        """
        for t in task_types:
    ...
    async def update_routing_rules(self, rules: dict):
        ...
        Args:
            rules (dict): A dictionary of routing rules to update.

        Returns:
            dict: A dictionary indicating success and the updated routing rules.
        """
    ...
    async def scale_resources(self, factor: float):
        ...
        Args:
            factor (float): The factor to scale resources by.

        Returns:
            dict: A dictionary indicating success and the scale factor.
        """
    ...
    async def enable_caching(self, cache_types):
        ...
        Args:
            cache_types (list[str]): A list of cache types to enable.

        Returns:
            dict: A dictionary indicating success and the enabled cache types.
        """
    ...
    async def update_validation_strategy(self, strategy: str):
        ...
        Args:
            strategy (str): The new validation strategy to use.
    ...
    async def integrate_external_capability(self, config: dict) -> bool:
        ...
        Args:
            config (dict): The configuration for the external capability.

        Returns:
            bool: True if the capability was integrated successfully.
        """
    ...
    async def remove_external_capability(self, capability_id: str) -> bool:
        ...
        Returns:
            bool: True if the capability was removed successfully, False otherwise.
        """
...
class SimpleMetricsClient:
    ...
    def __init__(self, _cfg):
        ...
        Args:
            _cfg (dict): The configuration for the metrics client.
        """
        pass
    async def get_current_metrics(self):
        ...
        Returns:
            dict: A dictionary of current metrics.
        """
